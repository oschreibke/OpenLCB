// decode a CANASCII message to CAN
...
enum WiFiDecodeStatus decodeStatus = expect_colon;

bool CanAscii2Can(uint32_t * id, enum CAN_message_type * messageType, uint8_t * len, uint8_t dataBuf[], char * ch){
      int i = 0;
